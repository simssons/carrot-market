  ...
  return (
    <>
      {data ? (
        ...
        <div className="mt-4 text-gray-600 text-sm"></div>
      )}
    </>
  );
};
    ...
    <>
      <div className="flex items-center mt-4 space-x-3">
        {user?.avatar ? (
          ...
          // <Image
          //   src={`https://imagedelivery.net/0dNSIQsfAsyuUaSo7XjPgQ/${user?.avatar}/avatar`}
          //   className="w-16 h-16 bg-slate-500 rounded-full"
          //   alt="profile"
          //   width={16}
          //   height={16}
  ...
  return (
    <Layout hasTabBar title="나의 캐럿" seoTitle="Profile">
      <div className="px-4">
        ...
        <Suspense fallback="Loading Mini Reviews">
          <Reviews />
        </Suspense>
      </div>
    </Layout>
