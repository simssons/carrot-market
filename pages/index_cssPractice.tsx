  ...
  return (
    ...
    <div className="flex flex-col space-y-2 p-5">
      {/* <p className="first-letter:text-7xl first-letter:text-purple-400">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. In, quos necessitatibus illo rem modi mollitia corrupti, aut cum eligendi totam quo, laboriosam quibusdam nam molestiae odio a ratione amet molestias?
      </p> */}
      {/* <input type="file"
      className="
        file:cursor-pointer
        file:hover:text-purple-500
        file:hover:bg-white
        file:hover:border-purple-500
        file:hover:border
    ...
    {/* <form className="flex flex-col space-y-2 p-5">
      ...
      <span className="hidden peer-invalid:block peer-">This input is invalid</span>
    ...
    {/* <div className="bg-slate-400 py-20 px-10 grid gap-10 min-h-screen">
      <div className="bg-white p-6 rounded-3xl shadow-xl">
        ...
        <ul>
          {[1,2,3,4,5].map((i)=>
          <div key={i} className="flex justify-between my-2 even:bg-cyan-400">
        ...
        <ul>
          {["a","b","c",""].map((c,i)=>
            <li key={i} className="bg-red-500 py-2 empty:hideden">{c}</li>
          )}
        </ul>
        ...
        <button className="mt-5 bg-blue-500 text-white p-2 text-center rounded-lg w-2/4 mx-auto
        hover:bg-teal-500
        hover:text-black
        active:bg-teal-100
        focus:bg-red-500
      ...
      <div className="bg-white overflow-hidden rounded-2xl shadow-xl group">
        ...
        <div className="rounded-3xl p-6 bg-white relative -top-5">
          <div className="flex relative -top-16 items-end justify-between">
            ...
            <div className="h-24 w-24 bg-red-400 rounded-full group-hover:bg-red-300 transition-colors group-" />
            <div className="flex flex-col items-center">
